...
public class DeviceControlActivity extends Activity {
    ...
    public void onLedClickOn(View v){
        if(mBluetoothLeService != null) {
            Log.i(TAG, "onLedClickOn");
            mBluetoothLeService.led_on(0x01);
            //mBluetoothLeService.writeCustomCharacteristic(0xaa);
        }
    }

    public void onLedClickOff(View v){
        if(mBluetoothLeService != null) {
            Log.i(TAG, "onLedClickOff");
            mBluetoothLeService.led_on(0x00);
            //mBluetoothLeService.writeCustomCharacteristic(0xaa);
        }
    }
    ...
    Log.i (TAG, "onClickNotify");
        if (mGattCharacteristics != null) {
            Log.i(TAG, "mGattCharacteristics != null");
            mBluetoothLeService.SetNotifyCustomCharacteristic();
        }
