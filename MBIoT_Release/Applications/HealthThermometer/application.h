...
#define CMD_LEN_TEMP_MEASUREMENT		5
#define CMD_LEN_DISCONNECT				10
#define CMD_LEN_INTERMEDIATE_MEASUREMENT 9
#define CMD_LEN_TEMPERATURE_MEAUSREMENT_INTERVAL 12
#define CMD_LEN_STOP_TEMPERATURE_MEAUSREMENT_INTERVAL_INDICATION 4


/**@brief Definition of command index. */
enum CMD_INDEX
{
	CMD_SEND_TEMP_MEASUREMENT,									/**< Length of send Temp Measurement command. */
	CMD_SEND_INTERMEDIATE_MEASUREMENT,
	CMD_SEND_TEMPERATURE_MEAUSREMENT_INTERVAL,
	CMD_STOP_TEMPERATURE_MEAUSREMENT_INTERVAL_INDICATION,
